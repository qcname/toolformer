# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_data_generator.ipynb.

# %% auto 0
__all__ = ['AugmentedCandidate', 'DataGenerator']

# %% ../nbs/00_data_generator.ipynb 2
import re
...
# %% ../nbs/00_data_generator.ipynb 3
class AugmentedCandidate(TypedDict):
    api_start_positions:int

# %% ../nbs/00_data_generator.ipynb 4
